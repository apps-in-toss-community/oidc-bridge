...
# Node as PID 1 is fine for this stateless service — Docker / orchestrators
# deliver SIGTERM to PID 1 and @hono/node-server handles it. No `tini` needed.
# `--enable-source-maps` keeps stack traces readable in logs.
