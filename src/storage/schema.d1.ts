/**
 * D1 schema. Hand-mirrored from schema.sqlite.ts because drizzle-orm has no
 * cross-dialect helper. D1 uses the same `drizzle-orm/sqlite-core` builders
 * as the local SQLite adapter — the divergence point is the runtime driver
 * (`drizzle-orm/d1` vs `better-sqlite3`).
 */
